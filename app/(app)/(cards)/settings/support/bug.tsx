...
export default function ReportBugScreen() {
  ...
  const handleSend = async () => {
    if (!message.trim()) {
      Alert.alert('Error', 'Please describe the bug before sending.');
      return;
    }

    const subject = 'Bug Report - Atlas App';
    ...
    try {
      ...
      setMessage('');
      Alert.alert('Success', 'Your bug report has been opened in your email app.');
    } catch (error) {
